...
export const yucatanPremiumLandingConfig: PremiumLandingConfig = {
  id: "yucatan-premium",
  routePath: "/yucatan-premium",
  metadata: {
    title: "Yucatan Premium",
    description: "Yucatan Premium",
  ...
  navbar: {
    ...
    menuItems: [...YUCATAN_MENU_ITEMS],
    colors: ["var(--primary-yucatan)", "var(--secondary-yucatan)"],
    accentColor: "var(--primary-yucatan)",
    menuButtonColor: "#ffffff",
    openMenuButtonColor: "#16181b",
  },
  sections: {
    hero: {
      seoHeading: "Viaja a Yucatan desde Mexico",
      title: {
        line1Lead: "Viaja a",
        line1Focus: "Yucatan",
        line2Lead: "desde",
