...
export const chiapasPremiumLandingConfig: PremiumLandingConfig = {
  id: "chiapas-premium",
  routePath: "/chiapas-premium",
  metadata: {
    title: "Chiapas Premium",
    description: "Chiapas Premium",
  ...
  navbar: {
    ...
    menuItems: [...CHIAPAS_MENU_ITEMS],
    colors: ["var(--primary-chiapas)", "var(--secondary-chiapas)"],
    accentColor: "var(--primary-chiapas)",
  ...
  sections: {
    ...
    footer: {
      srHeading: "Footer Chiapas Premium",
      logoWord: "CHIAPAS",
