...
export default function ImageSectionForm({
  ...
  const handleFinalSubmit = useCallback(async () => {
    ...
    try {
      ...
      alert(
        "Hubo un error al enviar tu solicitud. Por favor intenta de nuevo o contactanos directamente.",
      );
    } finally {
      setIsSubmitting(false);
    }
  }, [config, crmTag, idPrefix, isSubmitting, values]);
  ...
  return (
    <div className={`${styles.formContainer} ${themeClassName}`}>
      ...
      <form className={styles.stepperRoot}>
        <input
          type="hidden"
        ...
        <input
          type="hidden"
          name={fieldLabels.travelDate}
          value={values.travelDate}
          readOnly
        />
        <input
          type="hidden"
          name={fieldLabels.travelers}
          value={values.travelers}
          readOnly
        />
        <input
          type="hidden"
          name={fieldLabels.japanWishes}
          value={values.japanWishes}
          readOnly
        />
        <input
          type="hidden"
          name={fieldLabels.experienceType}
          value={values.experienceType || "No especificado"}
          readOnly
        />
        <Stepper
            ...
            isSubmitted ? (
              <div className={styles.completion}>
                ...
                <p className={styles.completionText}>
                  Gracias por compartir tu idea de viaje. Te contactaremos
                  pronto.
                </p>
                <button
                  type="button"
        ...
        >
          ...
          <Step>
            ...
            >
              {config.experienceOptions &&
              config.experienceOptions.length > 0 ? (
                <ExperienceChips
