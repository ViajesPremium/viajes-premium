...
export const coreaPremiumLandingConfig: PremiumLandingConfig = {
  id: "corea-premium",
  routePath: "/corea-premium",
  metadata: {
    title: "Corea Premium",
    description: "Corea Premium",
  ...
  navbar: {
    logoUrl: "/logos/corea/logo-corea.svg",
    menuItems: [...COREA_MENU_ITEMS],
    colors: ["var(--primary-corea)", "var(--secondary-corea)"],
    accentColor: "var(--primary-corea)",
    menuButtonColor: "#ffffff",
    openMenuButtonColor: "#16181b",
  },
  sections: {
    hero: {
      seoHeading: "Viaja a Corea desde Mexico",
      title: {
        line1Lead: "Viaja a",
        line1Focus: "Corea",
        line2Lead: "desde",
